...
<div className="container-fluid bg-primary text-white mt-5 pt-5 ">
    <div className="row px-xl-5 pt-5 ">
        <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5 MyCustomFont text-start" >
            ...
            <div className="flex flex-column justify-content-start text-start MyCustomFont">
            ...
            <div className="row">
                <div className="col-md-4 mb-5  text-start ">
                    ...
                    <div className="d-flex flex-column  text-start   ">
                        ...
                        <Link className="text-white mb-2 text-decoration-none hoverchangeA" to="/shop">Shop</Link>
                        <Link className="text-white mb-2 text-decoration-none hoverchangeA" href="/cart">Shopping Cart
                        </Link>
                        <Link className="text-white mb-2 text-decoration-none hoverchangeA" href="/contact"> Contact Us</Link>
                    </div>
                </div>
                <div className="col-md-4 mb-5 MyCustomFont">
                    <h5 className="text-uppercase mb-4 text-start">My Account</h5>
                    <div className="d-flex flex-column justify-content-start text-start  ">
                    
                        <Link className="text-white mb-2 text-decoration-none  " to="/userprofile"> UserProfile
                        </Link>
                        <Link className="text-white mb-2 text-decoration-none" to="/settings"> Settings
                        </Link>
                        <Link className="text-white mb-2 text-decoration-none" to="/wishlist"> WishList
                        </Link>
                        <Link className="text-white mb-2 text-decoration-none" href="#">ChangePassword</Link>
                    </div>
                </div>
                <div className="col-md-4 mb-5 MyCustomFont text-start">
    ...
    <div className="row border-top mx-xl-5 py-4" style={{borderColor: 'rgba(256, 256, 256, .1) !important'}}>
        <div className="col-md-6 px-xl-0">
            <p className="mb-md-0 text-start text-md-left ">
